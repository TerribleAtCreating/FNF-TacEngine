...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Extra Text', "Changes the text that is below the song watermark."]
	];
	...
	**/
	...
	var extraTextInputText:FlxUIInputText;
	...
	function addSongUI():Void
	{
		...
		extraTextInputText = new FlxUIInputText(stageDropDown.x, noteSplashesInputText.y + 35, 125, _song.extraText, 8);
		blockPressWhileTypingOn.push(extraTextInputText);
		...
		tab_group_song.add(extraTextInputText);
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
	{
		...
		else if (id == FlxUINumericStepper.CHANGE_EVENT && (sender is FlxUINumericStepper))
		{
			...
			if(sender == extraTextInputText) {
				_song.extraText = extraTextInputText.text;
			}
	...
	{
		var daSong:String = Highscore.formatSong(song, PlayState.storyDifficulty);
		PlayState.SONG = Song.loadFromJson(daSong, song.toLowerCase());
		MusicBeatState.resetState();
	}
