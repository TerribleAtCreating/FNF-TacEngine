...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		textBG.alpha = 0.6;
		add(textBG);
		var text:FlxText = new FlxText(textBG.x, textBG.y + 4, FlxG.width, "Press CTRL to open the Modifiers Menu / Press SPACE to preview the song. / Press RESET to Reset your PB.", 18);
	...
	function changeDiff(change:Int = 0, isAlt:Bool = false)
	{
		if (!isAlt)
		{
		...
		diffText.text = '< ' + CoolUtil.difficultyString() + ' - ' + CoolUtil.modeString() + ' >';
		positionHighscore();
	}
